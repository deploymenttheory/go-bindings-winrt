...
// ReadSingle dispatches through IDataReader's vtable slot 24.
func (self *IDataReader) ReadSingle() (float32, error) {
	result := new(float32)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[24], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}

// ReadDouble dispatches through IDataReader's vtable slot 25.
func (self *IDataReader) ReadDouble() (float64, error) {
	result := new(float64)
...
// WriteGuid dispatches through IDataWriter's vtable slot 16.
func (self *IDataWriter) WriteGuid(value win32.GUID) error {
	r1, _, _ := syscall.SyscallN(self.LpVtbl[16], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(&value))))
	return win32.ErrIfFailed(int32(r1))
}
...
// WriteSingle dispatches through IDataWriter's vtable slot 23.
func (self *IDataWriter) WriteSingle(value float32) error {
	_value := uintptr(math.Float32bits(value))
	r1, _, _ := syscall.SyscallN(self.LpVtbl[23], uintptr(unsafe.Pointer(self)), _value)
	return win32.ErrIfFailed(int32(r1))
}

// WriteDouble dispatches through IDataWriter's vtable slot 24.
func (self *IDataWriter) WriteDouble(value float64) error {
