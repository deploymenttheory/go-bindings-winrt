...
// CreateInstanceWithLocationAndHeading constructs a Windows.UI.Xaml.Controls.Maps.MapCamera instance through
// Windows.UI.Xaml.Controls.Maps.IMapCameraFactory.CreateInstanceWithLocationAndHeading. The activation factory is fetched
// per call (a factory cache is a future optimization).
func CreateInstanceWithLocationAndHeading(location *devicesgeolocation.IGeopoint, headingInDegrees float64) (*MapCamera, error) {
	factoryUnknown, err := winrt.GetActivationFactory("Windows.UI.Xaml.Controls.Maps.MapCamera", &IID_IMapCameraFactory)
	if err != nil {
		return nil, err
	}
	factory := (*IMapCameraFactory)(unsafe.Pointer(factoryUnknown))
	defer factory.Release()
	instance, err := factory.CreateInstanceWithLocationAndHeading(location, headingInDegrees)
	if err != nil {
		return nil, err
	}
	return (*MapCamera)(unsafe.Pointer(instance)), nil
...
// CreateInstanceWithLocationHeadingAndPitch constructs a Windows.UI.Xaml.Controls.Maps.MapCamera instance through
// Windows.UI.Xaml.Controls.Maps.IMapCameraFactory.CreateInstanceWithLocationHeadingAndPitch. The activation factory is fetched
// per call (a factory cache is a future optimization).
func CreateInstanceWithLocationHeadingAndPitch(location *devicesgeolocation.IGeopoint, headingInDegrees float64, pitchInDegrees float64) (*MapCamera, error) {
	factoryUnknown, err := winrt.GetActivationFactory("Windows.UI.Xaml.Controls.Maps.MapCamera", &IID_IMapCameraFactory)
	if err != nil {
		return nil, err
	}
	factory := (*IMapCameraFactory)(unsafe.Pointer(factoryUnknown))
	defer factory.Release()
	instance, err := factory.CreateInstanceWithLocationHeadingAndPitch(location, headingInDegrees, pitchInDegrees)
	if err != nil {
		return nil, err
	}
	return (*MapCamera)(unsafe.Pointer(instance)), nil
...
// CreateInstanceWithLocationHeadingPitchRollAndFieldOfView constructs a Windows.UI.Xaml.Controls.Maps.MapCamera instance through
// Windows.UI.Xaml.Controls.Maps.IMapCameraFactory.CreateInstanceWithLocationHeadingPitchRollAndFieldOfView. The activation factory is fetched
// per call (a factory cache is a future optimization).
func CreateInstanceWithLocationHeadingPitchRollAndFieldOfView(location *devicesgeolocation.IGeopoint, headingInDegrees float64, pitchInDegrees float64, rollInDegrees float64, fieldOfViewInDegrees float64) (*MapCamera, error) {
	factoryUnknown, err := winrt.GetActivationFactory("Windows.UI.Xaml.Controls.Maps.MapCamera", &IID_IMapCameraFactory)
	if err != nil {
		return nil, err
	}
	factory := (*IMapCameraFactory)(unsafe.Pointer(factoryUnknown))
	defer factory.Release()
	instance, err := factory.CreateInstanceWithLocationHeadingPitchRollAndFieldOfView(location, headingInDegrees, pitchInDegrees, rollInDegrees, fieldOfViewInDegrees)
	if err != nil {
		return nil, err
	}
	return (*MapCamera)(unsafe.Pointer(instance)), nil
...
// NewMapTileSourceWithDataSourceAndZoomRange constructs a Windows.UI.Xaml.Controls.Maps.MapTileSource instance through
// Windows.UI.Xaml.Controls.Maps.IMapTileSourceFactory.CreateInstanceWithDataSourceAndZoomRange with a NULL controlling outer: the
// class is created as itself, not derived from (instantiate-only
// composition). The activation factory is fetched per call (a factory cache
// is a future optimization).
func NewMapTileSourceWithDataSourceAndZoomRange(dataSource *IMapTileDataSource, zoomLevelRange MapZoomLevelRange) (*MapTileSource, error) {
	factoryUnknown, err := winrt.GetActivationFactory("Windows.UI.Xaml.Controls.Maps.MapTileSource", &IID_IMapTileSourceFactory)
	if err != nil {
		return nil, err
	}
	...
	defer factory.Release()
	inner := new(*syswinrt.IInspectable)
	instance, err := factory.CreateInstanceWithDataSourceAndZoomRange(dataSource, zoomLevelRange, nil, inner)
	if err != nil {
		return nil, err
	}
	if *inner != nil {
...
// NewMapTileSourceWithDataSourceZoomRangeAndBounds constructs a Windows.UI.Xaml.Controls.Maps.MapTileSource instance through
// Windows.UI.Xaml.Controls.Maps.IMapTileSourceFactory.CreateInstanceWithDataSourceZoomRangeAndBounds with a NULL controlling outer: the
// class is created as itself, not derived from (instantiate-only
// composition). The activation factory is fetched per call (a factory cache
// is a future optimization).
func NewMapTileSourceWithDataSourceZoomRangeAndBounds(dataSource *IMapTileDataSource, zoomLevelRange MapZoomLevelRange, bounds *devicesgeolocation.IGeoboundingBox) (*MapTileSource, error) {
	factoryUnknown, err := winrt.GetActivationFactory("Windows.UI.Xaml.Controls.Maps.MapTileSource", &IID_IMapTileSourceFactory)
	if err != nil {
		return nil, err
	}
	...
	defer factory.Release()
	inner := new(*syswinrt.IInspectable)
	instance, err := factory.CreateInstanceWithDataSourceZoomRangeAndBounds(dataSource, zoomLevelRange, bounds, nil, inner)
	if err != nil {
		return nil, err
	}
	if *inner != nil {
...
// NewMapTileSourceWithDataSourceZoomRangeBoundsAndTileSize constructs a Windows.UI.Xaml.Controls.Maps.MapTileSource instance through
// Windows.UI.Xaml.Controls.Maps.IMapTileSourceFactory.CreateInstanceWithDataSourceZoomRangeBoundsAndTileSize with a NULL controlling outer: the
// class is created as itself, not derived from (instantiate-only
// composition). The activation factory is fetched per call (a factory cache
// is a future optimization).
func NewMapTileSourceWithDataSourceZoomRangeBoundsAndTileSize(dataSource *IMapTileDataSource, zoomLevelRange MapZoomLevelRange, bounds *devicesgeolocation.IGeoboundingBox, tileSizeInPixels int32) (*MapTileSource, error) {
	factoryUnknown, err := winrt.GetActivationFactory("Windows.UI.Xaml.Controls.Maps.MapTileSource", &IID_IMapTileSourceFactory)
	if err != nil {
		return nil, err
	}
	...
	defer factory.Release()
	inner := new(*syswinrt.IInspectable)
	instance, err := factory.CreateInstanceWithDataSourceZoomRangeBoundsAndTileSize(dataSource, zoomLevelRange, bounds, tileSizeInPixels, nil, inner)
	if err != nil {
		return nil, err
	}
	if *inner != nil {
...
// CreateInstanceWithPanoramaHeadingPitchAndFieldOfView constructs a Windows.UI.Xaml.Controls.Maps.StreetsideExperience instance through
// Windows.UI.Xaml.Controls.Maps.IStreetsideExperienceFactory.CreateInstanceWithPanoramaHeadingPitchAndFieldOfView. The activation factory is fetched
// per call (a factory cache is a future optimization).
func CreateInstanceWithPanoramaHeadingPitchAndFieldOfView(panorama *IStreetsidePanorama, headingInDegrees float64, pitchInDegrees float64, fieldOfViewInDegrees float64) (*StreetsideExperience, error) {
	factoryUnknown, err := winrt.GetActivationFactory("Windows.UI.Xaml.Controls.Maps.StreetsideExperience", &IID_IStreetsideExperienceFactory)
	if err != nil {
		return nil, err
	}
	factory := (*IStreetsideExperienceFactory)(unsafe.Pointer(factoryUnknown))
	defer factory.Release()
	instance, err := factory.CreateInstanceWithPanoramaHeadingPitchAndFieldOfView(panorama, headingInDegrees, pitchInDegrees, fieldOfViewInDegrees)
	if err != nil {
		return nil, err
	}
	return (*StreetsideExperience)(unsafe.Pointer(instance)), nil
