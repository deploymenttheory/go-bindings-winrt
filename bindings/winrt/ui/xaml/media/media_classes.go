...
// CreateInstanceWithGradientStopCollectionAndAngle constructs a Windows.UI.Xaml.Media.LinearGradientBrush instance through
// Windows.UI.Xaml.Media.ILinearGradientBrushFactory.CreateInstanceWithGradientStopCollectionAndAngle. The activation factory is fetched
...
func CreateInstanceWithGradientStopCollectionAndAngle(gradientStopCollection *syswinrt.IInspectable, angle float64) (*LinearGradientBrush, error) {
	factoryUnknown, err := winrt.GetActivationFactory("Windows.UI.Xaml.Media.LinearGradientBrush", &IID_ILinearGradientBrushFactory)
	if err != nil {
		return nil, err
	}
...
// CreateInstanceWithColor constructs a Windows.UI.Xaml.Media.SolidColorBrush instance through
// Windows.UI.Xaml.Media.ISolidColorBrushFactory.CreateInstanceWithColor. The activation factory is fetched
// per call (a factory cache is a future optimization).
func CreateInstanceWithColor(color ui.Color) (*SolidColorBrush, error) {
	factoryUnknown, err := winrt.GetActivationFactory("Windows.UI.Xaml.Media.SolidColorBrush", &IID_ISolidColorBrushFactory)
	if err != nil {
		return nil, err
	}
