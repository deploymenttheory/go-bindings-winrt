...
// CreateInstanceWithCenterAndRadius constructs a Windows.UI.Xaml.Input.ManipulationPivot instance through
// Windows.UI.Xaml.Input.IManipulationPivotFactory.CreateInstanceWithCenterAndRadius. The activation factory is fetched
// per call (a factory cache is a future optimization).
func CreateInstanceWithCenterAndRadius(center foundation.Point, radius float64) (*ManipulationPivot, error) {
	factoryUnknown, err := winrt.GetActivationFactory("Windows.UI.Xaml.Input.ManipulationPivot", &IID_IManipulationPivotFactory)
	if err != nil {
		return nil, err
	}
