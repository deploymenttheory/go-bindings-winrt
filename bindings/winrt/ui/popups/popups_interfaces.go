...
// ShowAsync dispatches through IPopupMenu's vtable slot 7.
func (self *IPopupMenu) ShowAsync(invocationPoint foundation.Point) (*IAsyncOperationOfIUICommand, error) {
	_invocationPoint := *(*uintptr)(unsafe.Pointer(&invocationPoint))
	result := new(*IAsyncOperationOfIUICommand)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[7], uintptr(unsafe.Pointer(self)), _invocationPoint, uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}

// ShowAsyncWithRect dispatches through IPopupMenu's vtable slot 8.
func (self *IPopupMenu) ShowAsyncWithRect(selection foundation.Rect) (*IAsyncOperationOfIUICommand, error) {
	result := new(*IAsyncOperationOfIUICommand)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[8], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(&selection))), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}

// ShowAsyncWithRectAndPlacement dispatches through IPopupMenu's vtable slot 9.
func (self *IPopupMenu) ShowAsyncWithRectAndPlacement(selection foundation.Rect, preferredPlacement Placement) (*IAsyncOperationOfIUICommand, error) {
	result := new(*IAsyncOperationOfIUICommand)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[9], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(&selection))), uintptr(preferredPlacement), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
