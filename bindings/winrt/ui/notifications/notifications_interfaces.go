...
func (self *IBadgeUpdater) StartPeriodicUpdateAtTime(badgeContent *foundation.IUriRuntimeClass, startTime foundation.DateTime, requestedInterval PeriodicUpdateRecurrence) error {
	...
	r1, _, _ := syscall.SyscallN(self.LpVtbl[9], uintptr(unsafe.Pointer(self)), uintptr(unsafe.Pointer(badgeContent)), _startTime, uintptr(requestedInterval))
	return win32.ErrIfFailed(int32(r1))
}
...
func (self *IScheduledTileNotificationFactory) CreateScheduledTileNotification(content *dataxmldom.IXmlDocument, deliveryTime foundation.DateTime) (*IScheduledTileNotification, error) {
	_deliveryTime := *(*uintptr)(unsafe.Pointer(&deliveryTime))
	result := new(*IScheduledTileNotification)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[6], uintptr(unsafe.Pointer(self)), uintptr(unsafe.Pointer(content)), _deliveryTime, uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
func (self *IScheduledToastNotificationFactory) CreateScheduledToastNotificationRecurring(content *dataxmldom.IXmlDocument, deliveryTime foundation.DateTime, snoozeInterval foundation.TimeSpan, maximumSnoozeCount uint32) (*IScheduledToastNotification, error) {
	_deliveryTime := *(*uintptr)(unsafe.Pointer(&deliveryTime))
	_snoozeInterval := *(*uintptr)(unsafe.Pointer(&snoozeInterval))
	result := new(*IScheduledToastNotification)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[7], uintptr(unsafe.Pointer(self)), uintptr(unsafe.Pointer(content)), _deliveryTime, _snoozeInterval, uintptr(maximumSnoozeCount), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
func (self *ITileFlyoutUpdater) StartPeriodicUpdateAtTime(tileFlyoutContent *foundation.IUriRuntimeClass, startTime foundation.DateTime, requestedInterval PeriodicUpdateRecurrence) error {
	_startTime := *(*uintptr)(unsafe.Pointer(&startTime))
	r1, _, _ := syscall.SyscallN(self.LpVtbl[9], uintptr(unsafe.Pointer(self)), uintptr(unsafe.Pointer(tileFlyoutContent)), _startTime, uintptr(requestedInterval))
	return win32.ErrIfFailed(int32(r1))
}
...
func (self *ITileUpdater) StartPeriodicUpdateAtTime(tileContent *foundation.IUriRuntimeClass, startTime foundation.DateTime, requestedInterval PeriodicUpdateRecurrence) error {
	_startTime := *(*uintptr)(unsafe.Pointer(&startTime))
	r1, _, _ := syscall.SyscallN(self.LpVtbl[14], uintptr(unsafe.Pointer(self)), uintptr(unsafe.Pointer(tileContent)), _startTime, uintptr(requestedInterval))
	return win32.ErrIfFailed(int32(r1))
}
...
func (self *ITileUpdater) StartPeriodicUpdateBatchAtTime(tileContents *IIterableOfUri, startTime foundation.DateTime, requestedInterval PeriodicUpdateRecurrence) error {
	_startTime := *(*uintptr)(unsafe.Pointer(&startTime))
	r1, _, _ := syscall.SyscallN(self.LpVtbl[17], uintptr(unsafe.Pointer(self)), uintptr(unsafe.Pointer(tileContents)), _startTime, uintptr(requestedInterval))
	return win32.ErrIfFailed(int32(r1))
}
