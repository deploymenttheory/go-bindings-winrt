...
// TryResizeView dispatches through IApplicationView3's vtable slot 13.
func (self *IApplicationView3) TryResizeView(value foundation.Size) (bool, error) {
	_value := *(*uintptr)(unsafe.Pointer(&value))
	result := new(byte)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[13], uintptr(unsafe.Pointer(self)), _value, uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result != 0, win32.ErrIfFailed(int32(r1))
}

// SetPreferredMinSize dispatches through IApplicationView3's vtable slot 14.
func (self *IApplicationView3) SetPreferredMinSize(minSize foundation.Size) error {
	_minSize := *(*uintptr)(unsafe.Pointer(&minSize))
	r1, _, _ := syscall.SyscallN(self.LpVtbl[14], uintptr(unsafe.Pointer(self)), _minSize)
	return win32.ErrIfFailed(int32(r1))
}
...
// SetPreferredLaunchViewSize (propput put_PreferredLaunchViewSize) dispatches through IApplicationViewStatics3's vtable slot 9.
func (self *IApplicationViewStatics3) SetPreferredLaunchViewSize(value foundation.Size) error {
	_value := *(*uintptr)(unsafe.Pointer(&value))
...
// RequestStartProjectingAsync dispatches through IProjectionManagerStatics2's vtable slot 7.
func (self *IProjectionManagerStatics2) RequestStartProjectingAsync(projectionViewId int32, anchorViewId int32, selection foundation.Rect) (*IAsyncOperationOfBool, error) {
	result := new(*IAsyncOperationOfBool)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[7], uintptr(unsafe.Pointer(self)), uintptr(projectionViewId), uintptr(anchorViewId), uintptr(winrt.OutParam(unsafe.Pointer(&selection))), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}

// RequestStartProjectingWithPlacementAsync dispatches through IProjectionManagerStatics2's vtable slot 8.
func (self *IProjectionManagerStatics2) RequestStartProjectingWithPlacementAsync(projectionViewId int32, anchorViewId int32, selection foundation.Rect, prefferedPlacement uipopups.Placement) (*IAsyncOperationOfBool, error) {
	result := new(*IAsyncOperationOfBool)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[8], uintptr(unsafe.Pointer(self)), uintptr(projectionViewId), uintptr(anchorViewId), uintptr(winrt.OutParam(unsafe.Pointer(&selection))), uintptr(prefferedPlacement), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
// TextScaleFactor (propget get_TextScaleFactor) dispatches through IUISettings2's vtable slot 6.
func (self *IUISettings2) TextScaleFactor() (float64, error) {
	result := new(float64)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[6], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
// SetCustomSize (propput put_CustomSize) dispatches through IViewModePreferences's vtable slot 9.
func (self *IViewModePreferences) SetCustomSize(value foundation.Size) error {
	_value := *(*uintptr)(unsafe.Pointer(&value))
	r1, _, _ := syscall.SyscallN(self.LpVtbl[9], uintptr(unsafe.Pointer(self)), _value)
	return win32.ErrIfFailed(int32(r1))
}
