...
// Equals dispatches through IGuidHelperStatics's vtable slot 8.
func (self *IGuidHelperStatics) Equals(target win32.GUID, value win32.GUID) (bool, error) {
	result := new(byte)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[8], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(&target))), uintptr(winrt.OutParam(unsafe.Pointer(&value))), uintptr(winrt.OutParam(unsafe.Pointer(result))))
...
// GetSingle dispatches through IPropertyValue's vtable slot 15.
func (self *IPropertyValue) GetSingle() (float32, error) {
	result := new(float32)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[15], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}

// GetDouble dispatches through IPropertyValue's vtable slot 16.
func (self *IPropertyValue) GetDouble() (float64, error) {
	result := new(float64)
...
// CreateSingle dispatches through IPropertyValueStatics's vtable slot 14.
func (self *IPropertyValueStatics) CreateSingle(value float32) (*syswinrt.IInspectable, error) {
...
// CreateDouble dispatches through IPropertyValueStatics's vtable slot 15.
func (self *IPropertyValueStatics) CreateDouble(value float64) (*syswinrt.IInspectable, error) {
...
// CreateGuid dispatches through IPropertyValueStatics's vtable slot 20.
func (self *IPropertyValueStatics) CreateGuid(value win32.GUID) (*syswinrt.IInspectable, error) {
	result := new(*syswinrt.IInspectable)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[20], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(&value))), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
func (self *IPropertyValueStatics) CreateDateTime(value DateTime) (*syswinrt.IInspectable, error) {
	...
	result := new(*syswinrt.IInspectable)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[21], uintptr(unsafe.Pointer(self)), _value, uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
func (self *IPropertyValueStatics) CreateTimeSpan(value TimeSpan) (*syswinrt.IInspectable, error) {
	_value := *(*uintptr)(unsafe.Pointer(&value))
	result := new(*syswinrt.IInspectable)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[22], uintptr(unsafe.Pointer(self)), _value, uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}

// CreatePoint dispatches through IPropertyValueStatics's vtable slot 23.
func (self *IPropertyValueStatics) CreatePoint(value Point) (*syswinrt.IInspectable, error) {
	_value := *(*uintptr)(unsafe.Pointer(&value))
	result := new(*syswinrt.IInspectable)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[23], uintptr(unsafe.Pointer(self)), _value, uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}

// CreateSize dispatches through IPropertyValueStatics's vtable slot 24.
func (self *IPropertyValueStatics) CreateSize(value Size) (*syswinrt.IInspectable, error) {
	_value := *(*uintptr)(unsafe.Pointer(&value))
	result := new(*syswinrt.IInspectable)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[24], uintptr(unsafe.Pointer(self)), _value, uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}

// CreateRect dispatches through IPropertyValueStatics's vtable slot 25.
func (self *IPropertyValueStatics) CreateRect(value Rect) (*syswinrt.IInspectable, error) {
	result := new(*syswinrt.IInspectable)
