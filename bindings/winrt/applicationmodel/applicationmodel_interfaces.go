...
// GetLogo dispatches through IAppDisplayInfo's vtable slot 8.
func (self *IAppDisplayInfo) GetLogo(size foundation.Size) (*storagestreams.IRandomAccessStreamReference, error) {
...
// GetLogoAsRandomAccessStreamReference dispatches through IPackage8's vtable slot 15.
func (self *IPackage8) GetLogoAsRandomAccessStreamReference(size foundation.Size) (*storagestreams.IRandomAccessStreamReference, error) {
	_size := *(*uintptr)(unsafe.Pointer(&size))
	result := new(*storagestreams.IRandomAccessStreamReference)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[15], uintptr(unsafe.Pointer(self)), _size, uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
// Progress (propget get_Progress) dispatches through IPackageContentGroupStagingEventArgs's vtable slot 8.
func (self *IPackageContentGroupStagingEventArgs) Progress() (float64, error) {
	result := new(float64)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[8], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
// Progress (propget get_Progress) dispatches through IPackageInstallingEventArgs's vtable slot 8.
func (self *IPackageInstallingEventArgs) Progress() (float64, error) {
	result := new(float64)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[8], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
// Progress (propget get_Progress) dispatches through IPackageStagingEventArgs's vtable slot 8.
func (self *IPackageStagingEventArgs) Progress() (float64, error) {
	result := new(float64)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[8], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
// Progress (propget get_Progress) dispatches through IPackageUninstallingEventArgs's vtable slot 8.
func (self *IPackageUninstallingEventArgs) Progress() (float64, error) {
	result := new(float64)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[8], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
// Progress (propget get_Progress) dispatches through IPackageUpdatingEventArgs's vtable slot 9.
func (self *IPackageUpdatingEventArgs) Progress() (float64, error) {
	result := new(float64)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[9], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
