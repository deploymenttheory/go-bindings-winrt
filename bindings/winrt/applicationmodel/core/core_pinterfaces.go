...
func (self *IAsyncOperationOfAppRestartFailureReason) GetResults() (AppRestartFailureReason, error) {
	result := new(AppRestartFailureReason)
...
func (self *IAsyncOperationOfAppRestartFailureReason) Await() (AppRestartFailureReason, error) {
...
type IVectorViewOfCoreApplicationView struct {
	syswinrt.IInspectable
}

// IID_IVectorViewOfCoreApplicationView is the interface identifier for IVectorViewOfCoreApplicationView.
var IID_IVectorViewOfCoreApplicationView = win32.GUID{Data1: 0xde9e16c4, Data2: 0x1b7c, Data3: 0x5126, Data4: [8]byte{0xb1, 0xd8, 0x7c, 0xd0, 0x4f, 0x13, 0xbd, 0x08}}

// GetAt dispatches through IVectorViewOfCoreApplicationView's vtable slot 6.
func (self *IVectorViewOfCoreApplicationView) GetAt(index uint32) (*ICoreApplicationView, error) {
...
// Size (propget get_Size) dispatches through IVectorViewOfCoreApplicationView's vtable slot 7.
func (self *IVectorViewOfCoreApplicationView) Size() (uint32, error) {
	result := new(uint32)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[7], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}

// IndexOf dispatches through IVectorViewOfCoreApplicationView's vtable slot 8.
func (self *IVectorViewOfCoreApplicationView) IndexOf(value *ICoreApplicationView, index *uint32) (bool, error) {
	result := new(byte)
