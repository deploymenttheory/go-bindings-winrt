...
// IndexOf dispatches through IVectorViewOfBasicGeoposition's vtable slot 8.
func (self *IVectorViewOfBasicGeoposition) IndexOf(value BasicGeoposition, index *uint32) (bool, error) {
	result := new(byte)
