...
// CreateFromDeviceClassId dispatches through IDeviceAccessInformationStatics's vtable slot 7.
func (self *IDeviceAccessInformationStatics) CreateFromDeviceClassId(deviceClassId win32.GUID) (*IDeviceAccessInformation, error) {
	result := new(*IDeviceAccessInformation)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[7], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(&deviceClassId))), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
// Show dispatches through IDevicePicker's vtable slot 15.
func (self *IDevicePicker) Show(selection foundation.Rect) error {
	r1, _, _ := syscall.SyscallN(self.LpVtbl[15], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(&selection))))
	return win32.ErrIfFailed(int32(r1))
}

// ShowWithPlacement dispatches through IDevicePicker's vtable slot 16.
func (self *IDevicePicker) ShowWithPlacement(selection foundation.Rect, placement uipopups.Placement) error {
	r1, _, _ := syscall.SyscallN(self.LpVtbl[16], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(&selection))), uintptr(placement))
	return win32.ErrIfFailed(int32(r1))
}

// PickSingleDeviceAsync dispatches through IDevicePicker's vtable slot 17.
func (self *IDevicePicker) PickSingleDeviceAsync(selection foundation.Rect) (*IAsyncOperationOfDeviceInformation, error) {
	result := new(*IAsyncOperationOfDeviceInformation)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[17], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(&selection))), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}

// PickSingleDeviceAsyncWithPlacement dispatches through IDevicePicker's vtable slot 18.
func (self *IDevicePicker) PickSingleDeviceAsyncWithPlacement(selection foundation.Rect, placement uipopups.Placement) (*IAsyncOperationOfDeviceInformation, error) {
	result := new(*IAsyncOperationOfDeviceInformation)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[18], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(&selection))), uintptr(placement), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result, win32.ErrIfFailed(int32(r1))
}
...
// SetForegroundColor (propput put_ForegroundColor) dispatches through IDevicePickerAppearance's vtable slot 9.
func (self *IDevicePickerAppearance) SetForegroundColor(value ui.Color) error {
...
// SetBackgroundColor (propput put_BackgroundColor) dispatches through IDevicePickerAppearance's vtable slot 11.
func (self *IDevicePickerAppearance) SetBackgroundColor(value ui.Color) error {
	_value := uintptr(*(*uint32)(unsafe.Pointer(&value)))
...
// SetAccentColor (propput put_AccentColor) dispatches through IDevicePickerAppearance's vtable slot 13.
func (self *IDevicePickerAppearance) SetAccentColor(value ui.Color) error {
	_value := uintptr(*(*uint32)(unsafe.Pointer(&value)))
...
// SetSelectedForegroundColor (propput put_SelectedForegroundColor) dispatches through IDevicePickerAppearance's vtable slot 15.
func (self *IDevicePickerAppearance) SetSelectedForegroundColor(value ui.Color) error {
	_value := uintptr(*(*uint32)(unsafe.Pointer(&value)))
...
// SetSelectedBackgroundColor (propput put_SelectedBackgroundColor) dispatches through IDevicePickerAppearance's vtable slot 17.
func (self *IDevicePickerAppearance) SetSelectedBackgroundColor(value ui.Color) error {
	_value := uintptr(*(*uint32)(unsafe.Pointer(&value)))
...
// SetSelectedAccentColor (propput put_SelectedAccentColor) dispatches through IDevicePickerAppearance's vtable slot 19.
func (self *IDevicePickerAppearance) SetSelectedAccentColor(value ui.Color) error {
	_value := uintptr(*(*uint32)(unsafe.Pointer(&value)))
