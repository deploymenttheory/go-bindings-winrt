...
// Lookup dispatches through IMapOfGuidAndObject's vtable slot 6.
func (self *IMapOfGuidAndObject) Lookup(key win32.GUID) (*syswinrt.IInspectable, error) {
	result := new(*syswinrt.IInspectable)
...
// HasKey dispatches through IMapOfGuidAndObject's vtable slot 8.
func (self *IMapOfGuidAndObject) HasKey(key win32.GUID) (bool, error) {
	result := new(byte)
...
// Insert dispatches through IMapOfGuidAndObject's vtable slot 10.
func (self *IMapOfGuidAndObject) Insert(key win32.GUID, value *syswinrt.IInspectable) (bool, error) {
	result := new(byte)
	r1, _, _ := syscall.SyscallN(self.LpVtbl[10], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(&key))), uintptr(unsafe.Pointer(value)), uintptr(winrt.OutParam(unsafe.Pointer(result))))
	return *result != 0, win32.ErrIfFailed(int32(r1))
}

// Remove dispatches through IMapOfGuidAndObject's vtable slot 11.
func (self *IMapOfGuidAndObject) Remove(key win32.GUID) error {
	r1, _, _ := syscall.SyscallN(self.LpVtbl[11], uintptr(unsafe.Pointer(self)), uintptr(winrt.OutParam(unsafe.Pointer(&key))))
	return win32.ErrIfFailed(int32(r1))
}
