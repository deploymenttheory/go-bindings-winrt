...
// IndexOf dispatches through IVectorOfGuid's vtable slot 9.
func (self *IVectorOfGuid) IndexOf(value win32.GUID, index *uint32) (bool, error) {
	result := new(byte)
...
// SetAt dispatches through IVectorOfGuid's vtable slot 10.
func (self *IVectorOfGuid) SetAt(index uint32, value win32.GUID) error {
...
// InsertAt dispatches through IVectorOfGuid's vtable slot 11.
func (self *IVectorOfGuid) InsertAt(index uint32, value win32.GUID) error {
...
// Append dispatches through IVectorOfGuid's vtable slot 13.
func (self *IVectorOfGuid) Append(value win32.GUID) error {
